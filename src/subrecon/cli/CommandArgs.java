...
public class CommandArgs {
    ...
    @Parameter(names = {"-verbose", "-v"}, required = false, description = "Print results for all sites, including those where P(A=a,B=b|D,θ,α) >= 1 - [threshold] where a==b (these are omitted by default)")
